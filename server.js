...
app.use(session({
    ...
    cookie: { secure: process.env.NODE_ENV === "production", sameSite: "none", domain: "project-2-event-planner-3ca0203f2eb1.herokuapp.com", httpOnly: true } // Use secure cookies in production
}));
